...
use Open_Search\Endpoints\Nodes\Hot_Threads;
use Open_Search\Endpoints\Nodes\Info;
use Open_Search\Endpoints\Nodes\Reload_Secure_Settings;
use Open_Search\Endpoints\Nodes\Stats;
use Open_Search\Endpoints\Nodes\Usage;
/**
 * Class NodesNamespace
 *
 * NOTE: This file is autogenerated using util/GenerateEndpoints.php
 */
class Nodes_Namespace extends Abstract_Namespace
{
    /**
    ...
    public function hot_threads(array $params = [])
    {
        ...
        $endpoint = $this->endpoint_factory->get_endpoint(Hot_Threads::class);
    ...
    {
        $node_id_or_metric = $this->extract_argument($params, 'node_id_or_metric');
        $metric = $this->extract_argument($params, 'metric');
        $node_id = $this->extract_argument($params, 'node_id');
        $endpoint = $this->endpoint_factory->get_endpoint(Info::class);
        $endpoint->set_params($params);
        $endpoint->set_node_id_or_metric($node_id_or_metric);
    ...
    public function reload_secure_settings(array $params = [])
    {
        ...
        $endpoint = $this->endpoint_factory->get_endpoint(Reload_Secure_Settings::class);
        $endpoint->set_params($params);
        $endpoint->set_node_id($node_id);
    ...
    public function usage(array $params = [])
    {
        $node_id = $this->extract_argument($params, 'node_id');
        $metric = $this->extract_argument($params, 'metric');
        $endpoint = $this->endpoint_factory->get_endpoint(Usage::class);
        $endpoint->set_params($params);
        $endpoint->set_node_id($node_id);
        $endpoint->set_metric($metric);
        return $this->perform_request($endpoint);
