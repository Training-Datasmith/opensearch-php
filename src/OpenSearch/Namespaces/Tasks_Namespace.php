...
use Open_Search\Endpoints\Tasks\Cancel;
use Open_Search\Endpoints\Tasks\Get;
use Open_Search\Endpoints\Tasks\List_Tasks;
/**
 * Class TasksNamespace
 *
 * NOTE: This file is autogenerated using util/GenerateEndpoints.php
 */
class Tasks_Namespace extends Abstract_Namespace
{
    /**
    ...
    public function cancel(array $params = [])
    {
        ...
        $endpoint = $this->endpoint_factory->get_endpoint(Cancel::class);
    ...
    {
        $endpoint = $this->endpoint_factory->get_endpoint(List_Tasks::class);
        $endpoint->set_params($params);
        return $this->perform_request($endpoint);
    }
    /**
     ...
     */
    public function tasks_list(array $params = [])
    {
