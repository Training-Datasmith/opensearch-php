...
use Open_Search\Endpoints\Insights\Top_Queries;
/**
 * Class InsightsNamespace
 *
 * NOTE: This file is autogenerated using util/GenerateEndpoints.php
 */
class Insights_Namespace extends Abstract_Namespace
{
    /**
     ...
     * @return array
     */
    public function top_queries(array $params = [])
    {
        $endpoint = $this->endpoint_factory->get_endpoint(Top_Queries::class);
