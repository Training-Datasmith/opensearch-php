...
use Open_Search\Endpoints\Security_Analytics\Get_Alerts;
use Open_Search\Endpoints\Security_Analytics\Get_Findings;
use Open_Search\Endpoints\Security_Analytics\Search_Finding_Correlations;
/**
 * Class SecurityAnalyticsNamespace
 *
 * NOTE: This file is autogenerated using util/GenerateEndpoints.php
 */
class Security_Analytics_Namespace extends Abstract_Namespace
{
    /**
     ...
     * @return array
     */
    public function get_alerts(array $params = [])
    {
        $endpoint = $this->endpoint_factory->get_endpoint(Get_Alerts::class);
     ...
     * @return array
     */
    public function get_findings(array $params = [])
    {
        $endpoint = $this->endpoint_factory->get_endpoint(Get_Findings::class);
        $endpoint->set_params($params);
        return $this->perform_request($endpoint);
    }
    /**
     ...
     * @return array
     */
    public function search_finding_correlations(array $params = [])
    {
        $endpoint = $this->endpoint_factory->get_endpoint(Search_Finding_Correlations::class);
        $endpoint->set_params($params);
        return $this->perform_request($endpoint);
    }
}