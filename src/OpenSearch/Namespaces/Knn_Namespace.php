...
use Open_Search\Endpoints\Knn\Delete_Model;
use Open_Search\Endpoints\Knn\Get_Model;
use Open_Search\Endpoints\Knn\Search_Models;
use Open_Search\Endpoints\Knn\Stats;
use Open_Search\Endpoints\Knn\Train_Model;
use Open_Search\Endpoints\Knn\Warmup;
/**
 * Class KnnNamespace
 *
 * NOTE: This file is autogenerated using util/GenerateEndpoints.php
 */
class Knn_Namespace extends Abstract_Namespace
{
    /**
     ...
     * @return array
     */
    public function train_model(array $params = [])
    {
        $model_id = $this->extract_argument($params, 'model_id');
        $body = $this->extract_argument($params, 'body');
        $endpoint = $this->endpoint_factory->get_endpoint(Train_Model::class);
        $endpoint->set_params($params);
        $endpoint->set_model_id($model_id);
        $endpoint->set_body($body);
        return $this->perform_request($endpoint);
    ...
    public function warmup(array $params = [])
    {
        ...
        $endpoint = $this->endpoint_factory->get_endpoint(Warmup::class);
        $endpoint->set_params($params);
