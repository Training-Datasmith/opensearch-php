...
@trigger_error(Everything_To_Json_Serializer::class . ' is deprecated in 2.4.0 and will be removed in 3.0.0.', E_USER_DEPRECATED);
 ...
 */
class Everything_To_Json_Serializer implements Serializer_Interface
{
    /**
     * {@inheritdoc}
     */
